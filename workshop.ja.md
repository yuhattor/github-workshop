...
<img src="images/image1.png" />をクリックしてください。
...
<img src="images/image2.png" /> をクリックします。
...
<img src="images/image3.png" />のようになります。

図4.3 - 新規リポジトリ作成ボタン

リポジトリ作成設定画面が表示されます。

<img src="images/image4.png" /> 新規リポジトリの作成画面が表示されます。
...
<img src="images/image5.png" /> をクリックしてください。
...
<img src="images/image11.png" /> を参照ください。
...
<img src="images/image12.png" /> 編集モードに入ります。

図4.12 - 編集モードに入る

2.  編集して変更をコミットすることができます。これはコードベースに直接コミットすることを覚えておいてください：

<img src="images/image13.png" /> このようにします。
...
<img src="images/image14.png" /> をクリックしてください。

図4.14 - 変更をコミットする

4. これで、以下のスクリーンショットのように変更が反映されるはずです。

<img src="images/image15.png" />のようになります。
...
<img src="images/image21.png" /> をクリックしてください。
...
<img src="images/image22.png" /> を参照ください。
...
<img src="images/image23.png" /> を参照ください。
...
<img src="images/image24.png" /> を参照ください。
...
<img src="images/image25.png" /> のようになります。
...
<img src="images/image26.png" />のようになります。
...
<img src="images/image27.png" /> をクリックします。
...
<img src="images/image28.png" />このようなMarkdownを使用してください。

図4.25 GitHub での課題の作成

課題の中でチームメンバーに割り当てたり、通知の内容で個人やチームに直接言及したりすることもできます。

<img src="images/image29.png" /> を参照ください。
...
<img src="images/image30.png" /> GitHub のワークフローに慣れてきたら、それに応じてアプローチを調整しましょう。

図4.27 - さまざまな種類のラベルを適用できる

最後に、投稿された課題が表示されます。

<img src="images/image31.png" /> （画像はイメージです。
...
<img src="images/image32.png" />のようにします。
...
<img src="images/image33.png" />のようにします。
...
<img src="images/image38.png" /> となります。
...
<img src="images/image39.png" /> をクリックしてください。
...
<img src="images/image43.png" />このようなプルリクエストを利用することで、チームメンバーやペアプログラミング・パートナーがコードをレビューすることができます。
...
<img src="images/image44.png" />をクリックしてください。
...
<img src="images/image48.png" /> をクリックします。
...
<img src="images/image51.png" />このボタンをクリックします。
...
<img src="images/image52.png" />このように表示されます。
...
<img src="images/image53.png" /> をクリックしてください。
...
<img src="images/image54.png" />このようなオプションがあります。

図4.51-レビューの3つのモード

承認すると、あなたのコメントと承認ステータスがこのようにスレッドに投稿されます：

<img src="images/image55.png" />のようになります。
...
<img src="images/image57.png" /> を参照。
...
<img src="images/image58.png" />のようになります。
...
<img src="images/image59.png" /> GitHub の開発ツールにアクセスする。
...
<img src="images/image60.png" /> GitHub Discussions は、GitHub ディスカッションに参加するための環境です。
...
<img src="images/image61.png" />のように。
...
<img src="images/image62.png" />のように設定します。
...
<img src="images/image63.png" /> （画像はイメージです。
...
<img src="images/image64.png" />このようなチェックを行うことで、チームはバグや問題がメインのコードベースに入り込むのを防ぐことができます。
...
<img src="images/image65.png" />のようにします。
...
<img src="images/image66.png" /> ##GitHubの課題テンプレートとプルリクエストテンプレート
...
<img src="images/image67.png" />このようなテンプレートを用意することで、必要な情報をすべて記載することができます。
